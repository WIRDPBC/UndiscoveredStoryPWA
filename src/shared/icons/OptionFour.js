...
const OptionFour = ({ fill, size, style, className, circleClassName, onClick, id }) => {
    ...
    return (
        ...
        <defs>
                ...
                <linearGradient id="linear-gradient" x1="24" y1="-8.39" x2="24" y2="58.73" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#27e9de"/><stop offset="0.52" stopColor="#03a4ec"/><stop offset="1" stopColor="#2547a8"/>
                </linearGradient>
